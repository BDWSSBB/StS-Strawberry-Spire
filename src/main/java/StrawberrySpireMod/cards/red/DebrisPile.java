...
public class DebrisPile extends AbstractStrawberrySpireCard {

    public static final String ID = "strawberrySpire:DebrisPile";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "StrawberrySpireModResources/cards/red/debrisPile.png";
