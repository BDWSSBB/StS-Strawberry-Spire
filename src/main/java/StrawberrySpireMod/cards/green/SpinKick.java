...
public class SpinKick extends AbstractStrawberrySpireCard {

    public static final String ID = "strawberrySpire:SpinKick";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "StrawberrySpireModResources/cards/green/spinKick.png";
