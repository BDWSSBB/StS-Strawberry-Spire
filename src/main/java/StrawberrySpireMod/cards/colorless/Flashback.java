...
public class Flashback extends AbstractStrawberrySpireCard {
    ...
    public static final String FLASHBACK_IMAGE_PATH = "StrawberrySpireModResources/cards/colorless/flashback.png";
    public static final String INVERT_IMAGE_PATH = "StrawberrySpireModResources/cards/colorless/invert.png";
    public static final String DUALITY_IMAGE_PATH = "StrawberrySpireModResources/cards/colorless/duality.png";
    public static final String MONOCHROME_IMAGE_PATH = "StrawberrySpireModResources/cards/colorless/monochrome.png";
