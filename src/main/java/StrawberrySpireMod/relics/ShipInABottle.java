...
public class ShipInABottle extends AbstractStrawberrySpireRelic { // Patched in GetRewardCardsPatches.java and GetColorlessRewardCardsPatches.
    ...
    public static final Texture IMAGE_PATH = ImageMaster.loadImage("StrawberrySpireModResources/relics/shipInABottle.png");
    public static final Texture IMAGE_OUTLINE_PATH = ImageMaster.loadImage("StrawberrySpireModResources/relics/outline/shipInABottle.png");
