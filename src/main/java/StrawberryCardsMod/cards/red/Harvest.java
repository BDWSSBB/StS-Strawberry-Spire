...
public class Harvest extends AbstractStrawberryCardsCard {

    public static final String ID = "strawberryCards:Harvest";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "cards/red/harvest.png";
