...
public class BreederCore extends AbstractStrawberryCardsCard {

    public static final String ID = "strawberryCards:BreederCore";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "cards/blue/breederCore.png";
