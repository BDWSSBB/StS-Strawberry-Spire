...
public class GearCrunch extends AbstractStrawberryCardsCard {

    public static final String ID = "strawberryCards:GearCrunch";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "cards/blue/gearCrunch.png";
