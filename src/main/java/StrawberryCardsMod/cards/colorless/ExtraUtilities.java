...
public class ExtraUtilities extends AbstractStrawberryCardsCard {

    public static final String ID = "strawberryCards:ExtraUtilities";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "cards/colorless/extraUtilities.png";
