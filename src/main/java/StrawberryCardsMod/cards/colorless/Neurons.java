...
public class Neurons extends AbstractStrawberryCardsCard {

    public static final String ID = "strawberryCards:Neurons";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String UPGRADE_NAME = "Newrons";
    public static final String IMAGE_PATH = "cards/colorless/neurons.png";
