...
public class Rummage extends AbstractStrawberryCardsCard {

    public static final String ID = "strawberryCards:Rummage";
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String NAME = CARD_STRINGS.NAME;
    public static final String IMAGE_PATH = "cards/green/rummage.png";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new RummageAction(this.magicNumber));
    }
